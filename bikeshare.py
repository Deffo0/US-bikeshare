...
def station_stats(df):
    ...
    print("Most Frequent Start Station: {}    count: {}".format(start_station_mode,df["Start Station"].value_counts()[start_station_mode]))

    # TO DO: display most commonly used end station
    end_station_mode = df["End Station"].mode()[0]
    print("Most Frequent End Station: {}    count: {}".format(end_station_mode,df["End Station"].value_counts()[end_station_mode]))
